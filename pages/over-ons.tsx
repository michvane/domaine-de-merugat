      ...
      <Container>
        <div style={{ backgroundColor: `${colors.main}15`, marginBottom: '2rem', padding: '2rem' }}>
            ...
            <p>
              ...
              leven. Drie jaar geleden toen we in de Tarn-et-Garonne streek met vakantie waren, gebeurde het, we werden
              ...
              natuur, vonden we onze droomplek: "Domaine de Merugat". We hebben niet geaarzeld, dit was de plaats waar
              we ons leven verder wilden zetten! En we willen graag deze heerlijke plek met jullie delen! Sinds 2 jaar
